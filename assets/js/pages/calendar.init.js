!function(g){
	"use strict";function e(){
		...
		{id:999,title:"Repeating Event",start:new Date(o,d,n+11,16,0),allDay:!1,className:"bg-primary"},
		{title:"Meeting",start:new Date(o,d,n,10,30),allDay:!1,className:"bg-success"},
		{title:"Lunch",start:new Date(o,d,n,12,0),end:new Date(o,d,n,14,0),allDay:!1,className:"bg-danger", dow:[1]},
		{title:"Birthday Party",start:new Date(o,d,n+1,19,0),end:new Date(o,d,n+1,22,30),allDay:!1,className:"bg-success"},
		{title:"Click for Google",start:new Date(o,d,28),end:new Date(o,d,29),url:"http://youtube.com/",className:"bg-dark"}],
		v=(
		...
		var m=new FullCalendar.Calendar(v,{
			...
			dateClick:function(e){u(e)},events:c});
		m.render(),
			...
			!1===s[0].checkValidity()?(
				event.preventDefault(),event.stopPropagation(),s[0].classList.add("was-validated")):(
					...
					i.setProp("classNames",[n])):(
						t={title:a,start:r.date,allDay:r.allDay,className:n},m.addEvent(t)),l.modal("hide")),
				console.log(t.start)
			}),
